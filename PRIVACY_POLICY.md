# PocketDeskies Privacy Policy

**Effective Date:** May 17, 2026
_Last updated: May 17, 2026_
**Version:** 1.1.0

PocketDeskies ("we," "our," or "us") is an Android app. PocketDeskies is an Android app for floating desktop-style companions and local customization. This Privacy Policy explains what information the app collects, how it is used, and the choices you have. By installing or using PocketDeskies you agree to the practices described below.

## Information We Collect

### Location Data
- PocketDeskies does not collect location data.

### Account Information
- No account is required to use PocketDeskies.

### Device Information
- Companion settings, display preferences, notification preferences, and local app configuration may be stored on your device.

## How We Use Your Information

### Location Sharing
- PocketDeskies does not use your location.

### Account Management
- Display floating companions and maintain local customization settings.

### Service Improvement
- Improve local companion behavior and reliability.
- We do not sell, rent, or monetize your settings.

## Storage and Retention

### Data Storage
- Settings and preferences are stored locally on your device.
- No Sudarshan Tech Labs cloud server is used for PocketDeskies data.

### Data Retention
- Local data remains until you delete it, clear app data, or uninstall the app.
...
### Family Groups
- PocketDeskies does not use MyFamilyTracker-style family groups unless explicitly described in this policy.
...
### Third Parties
- No PocketDeskies data is shared with third parties by Sudarshan Tech Labs.
...
* **SYSTEM_ALERT_WINDOW**: Used to display floating companions over other apps after you grant overlay permission.
* **FOREGROUND_SERVICE and FOREGROUND_SERVICE_SPECIAL_USE**: Used to keep the floating companion service active.
* **POST_NOTIFICATIONS and VIBRATE**: Used for companion/status notifications and feedback.
* **INTERNET**: Available for app features that require connectivity, if enabled in the installed version.

### Optional Permissions

* Overlay and notification permissions are controlled by you through Android settings.

## Your Rights and Controls

### Location Sharing Control
- No location sharing exists in PocketDeskies.

### Account Management
- No account is required.

### Data Access
- You can change or delete local settings in the app or Android settings.
...
### Permissions
- You can revoke Android permissions in Android Settings -> Apps -> PocketDeskies -> Permissions.
...
* **GitHub Repository:** https://github.com/SUDARSHANCHAUDHARI/pocketdeskies-privacy-policy
* **Email:** sunny.sudarshan@gmail.com
* **Main App Repository:** https://github.com/SUDARSHANCHAUDHARI/PocketDeskiesAndroid
...
- Subject: "Data Deletion Request - PocketDeskies"
...
1. Open PocketDeskies, if installed
...
- No third-party cloud service is required for core companion features.
...
PocketDeskies is built with privacy in mind. The app is built with:
- Kotlin and Jetpack Compose
- Android overlay/foreground service APIs
...
- **Clarified overlay behavior, local settings, and notification permissions.**
